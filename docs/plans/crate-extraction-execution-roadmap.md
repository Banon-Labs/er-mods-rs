...
| `startup_hooks/quit_menu/build_url_editor.rs` | 563 | System>Quit link field: submit, validate on accept, re-open on refusal | R18 |
...
| `startup_hooks/quit_menu/profile_rows_system_quit_menu.rs` | 2,012 | mixed profile-row title, quit, and sampler families | R11 |
...
| `startup_hooks/quit_menu/save_picker_path_editor.rs` | 1,118 | R13B1-R13B4 families listed in section 4.3 | R13A-R13B4 |

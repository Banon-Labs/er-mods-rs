...
| `gpu_readback/boot_progress.rs` | 2,969 | loading-bar, boot-cover, and product adapter families | R4-R5 |
...
| `startup_hooks/quit_menu/build_url_clipboard.rs` | 141 | clipboard read for the build-url editor prefill (the game never calls the clipboard APIs it links) | R18 |
| `startup_hooks/quit_menu/build_url_editor.rs` | 567 | System>Quit link field: submit, validate on accept, re-open on refusal | R18 |
...
| `startup_hooks/quit_menu/profile_05_010_editor_runtime.rs` | 1,899 | R12B1-R12B5 families listed in section 4.2 | R12A-R12B5 |
| `startup_hooks/quit_menu/profile_rows_system_quit_menu.rs` | 1,999 | mixed profile-row title, quit, and sampler families | R11 |
...
| `startup_hooks/quit_menu/save_picker_path_editor.rs` | 1,060 | R13B1-R13B4 families listed in section 4.3 | R13A-R13B4 |
...
| `startup_hooks/quit_menu/system_quit_row_identity.rs` | 318 | System>Quit row identity family | R18 |

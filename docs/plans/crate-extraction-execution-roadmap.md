...
| `startup_hooks/loading_cover/loading_cover_save_slot.rs` | 1,579 | save parsing, portrait, quit, telemetry, and product adapter families | R14-R18 |
...
| `startup_hooks/quit_menu/save_swap_profile_table.rs` | 1,271 | product profile renderer and quit swap families | R18-R19 |

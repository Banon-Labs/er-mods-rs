...
fn emit_address_map(root_dir: &str) {
    ...
    // The weaker source fills in only what the verified one does not already cover.
    ...
    let mut out = String::from(
        "// GENERATED by er-game-base/build.rs from rva-map-1162-to-1170.verified.tsv and\n\
         // rva-map-1162-to-1170.needed.tsv. 1.16.2 -> 1.17 pairs as (rva_1162, rva_1170),\n\
         // sorted by source RVA. Do not edit by hand.\n",
    );
    out.push_str(&format!(

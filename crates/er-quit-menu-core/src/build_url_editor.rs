...
//! user's own session shows exactly how that fails, from `er-quickload-autoload-debug.log`
...
use er_telemetry_core::counters::{
    ...
    SYSTEM_QUIT_LOAD_BUILD_URL_EDITOR_OPEN_COUNT, SYSTEM_QUIT_LOAD_BUILD_URL_LAST_REJECTION,
    SYSTEM_QUIT_LOAD_BUILD_URL_REFUSED_COUNT, SYSTEM_QUIT_LOAD_BUILD_URL_REJECTED_COUNT,
};

use crate::build_url_backdrop::{probe_live_build_url_backdrop, reset_build_url_backdrop_probe};
use crate::build_url_clipboard::{build_url_initial_text, clipboard_build_url, clipboard_sequence};
use crate::build_url_row::{persist_build_url, system_quit_start_build_import_url};
use crate::host::append_autoload_debug;
use crate::row_text::set_build_url_row_help;
use crate::scaleform_proxy::{place_text_input_02_990_caret_at_end, set_text_input_02_990_text};
use crate::software_keyboard::{
    BuildUrlKeyboardOutcome, build_url_keyboard_active, build_url_keyboard_latch_is_abandoned,
    build_url_menu_pump_tick, release_abandoned_build_url_keyboard, reset_build_url_keyboard_state,
...
pub fn build_url_editor_active() -> bool {
...
pub fn request_build_url_editor(dialog: usize) -> bool {
...
pub fn reset_build_url_editor_state() {
...
pub unsafe fn build_url_editor_window_run(base: usize, menu_window: usize) {

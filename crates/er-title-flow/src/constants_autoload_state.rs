...
pub const MENU_MEMBER_FUNC_JOB_RUN_RVA: usize = ProfileLoadMenuRva::MenuMemberFuncJobRun as usize;
...
pub const NATIVE_LOAD_LOG_INTERVAL: u64 = 120;
...
pub const FULLREAD_OWNER_NEW_GAME_OK: u8 = 0;
...
pub const FULLREAD_OWNER_GDM_08_OFFSET: usize = 0x08;
pub const FULLREAD_PHASE_DRAIN: usize = 1;
pub const FULLREAD_PHASE_DESER: usize = 2;
pub const FULLREAD_PHASE_DONE: usize = 4;
pub use er_telemetry_core::counters::FULLREAD_DRAIN_WAITS;
...
pub use er_telemetry_core::counters::FULLREAD_REQ_DISARM_COUNT;
pub use er_telemetry_core::counters::FULLREAD_REQ_DISARM_LAST_PREV_SLOT;
pub use er_telemetry_core::counters::LOADED_PEAK_C30;
pub use er_telemetry_core::counters::LOADED_PEAK_LEVEL;
pub use er_telemetry_core::counters::LOADED_PEAK_NAME_LEN;
...
pub use er_telemetry_core::counters::LOADED_PEAK_SEEN_COUNT;
pub static LOADED_PEAK_NAME: std::sync::Mutex<String> = std::sync::Mutex::new(String::new());
...
pub const IODEV_MOUNT_OPEN_RVA: usize = 0xe6e8d0;
/// The iodev getter 0x140e6e060() -> iodev (lazily creates the singleton if null).
pub const IODEV_GETTER_RVA: usize = 0xe6e060;
...
pub const SAVE_DIR_BUILDER_RVA: usize = 0xe0e680;
pub const SAVE_DIR_SETTER_RVA: usize = 0x240a2a0;
...
pub const SAVE_DIR_ALLOC_GETTER_RVA: usize = 0x1eba960;
...
pub const STEAM_ID64_GETTER_RVA: usize = 0xe8d590;
...
pub const U16STRING_ALLOC_OFFSET: usize = 0x00;
pub const U16STRING_DATA_OFFSET: usize = 0x08;
pub const U16STRING_SIZE_OFFSET: usize = 0x18;
pub const U16STRING_CAP_OFFSET: usize = 0x20;
pub const U16STRING_SSO_CAP: usize = 7;
/// [iodev+0x40] = the device-ready/bound byte flag (0 cold; set by the mount above).
pub const IODEV_READY_FLAG_40_OFFSET: usize = 0x40;
/// [iodev+0x30] = the OS file-handle slot (0xffffffff invalid until the mount opens it).
pub const IODEV_OS_HANDLE_30_OFFSET: usize = 0x30;
...
pub const IO_WORKER_REGISTRY_RVA: usize = 0x4843038;
...
pub const FD4_IO_WORKER_MGR_RVA: usize = RuntimeGlobalRva::SaveLoad2SlSystemImpl as usize;
pub const FD4_IO_WORKER_NOACCEPT_19_OFFSET: usize = 0x19;
...
pub const FD4_IO_WORKER_QUEUE_08_OFFSET: usize = 0x8;
pub const FD4_IO_WORKER_QUEUE_10_OFFSET: usize = 0x10;
/// The FD4 IO thread POOL singleton (abs 0x144853048).
pub const FD4_IO_POOL_RVA: usize = 0x4853048;
...
pub const IO_WORKER_REGISTRY_LIST_28_OFFSET: usize = 0x28;
#[allow(dead_code)] // Retained RE offset: decoded struct layout, no live reader today.
pub const INPUTMGR_PENDING_13C_OFFSET: usize = 0x13c;
...
#[allow(dead_code)] // Retained RE address: decoded from the game binary, no live caller today.
pub const MSGBOX_MULTI_CHOICE_GETTER_RVA: u32 = MsgBoxRva::MultiChoiceGetter as u32;
...
pub const MSGBOX_DIALOG_UPDATE_RVA: usize = MsgBoxRva::Update as usize;
/// Index of the `Update` entry in a MessageBoxDialog vtable (slot 2 == byte offset 0x10).
pub const MSGBOX_DIALOG_VTABLE_UPDATE_SLOT: usize = 2;
...
pub const MSGBOX_DEFAULT_CURSOR_25E0_OFFSET: usize =
...
pub const MSGBOX_BUTTON_COUNT_25E8_OFFSET: usize =
...
pub const MSGBOX_FIRST_BUTTON_INDEX: i32 = false as i32;
...
pub const MSGBOX_BUTTON_COUNT_MULTI_CHOICE: i32 = 2;
...
pub const MSGBOX_JOB_RESULT_STATE_1E8_OFFSET: usize =
    core::mem::offset_of!(MsgBoxDialogLayout, job_result_state);
pub const MSGBOX_JOB_RESULT_SUBCODE_1EC_OFFSET: usize =
...
pub const MENU_JOB_RESULT_STATE_CONTINUE_MAX: i32 = 1;
pub const MENU_JOB_RESULT_STATE_SUCCESS: i32 = 2;
pub const MENU_JOB_RESULT_STATE_FAILED: i32 = 3;
...
pub const MENU_JOB_RESULT_STATE_NONE: i32 = 0;
...
// save-request prologues into the title-flow crate purely as a side effect of the include's
// old position.
pub static MENU_JOB_EMIT_RESULT_ORIG: AtomicUsize = AtomicUsize::new(HOOK_ORIGINAL_UNSET);
pub const MENU_JOB_EMIT_RESULT_NOT_INSTALLED: usize = 0;
pub const MENU_JOB_EMIT_RESULT_INSTALLED_YES: usize = 1;
pub use er_telemetry_core::counters::MENU_JOB_EMIT_RESULT_INSTALLED;
...
pub const MSGBOX_FADE_CURRENT_1278_OFFSET: usize = 0x1278;
pub const MSGBOX_FADE_TARGET_2300_OFFSET: usize = 0x2300;
#[allow(dead_code)] // Retained RE constant: no live reader today, kept with the table it was decoded into.
pub const MSGBOX_FINISHED_TRUE: u8 = true as u8;
#[allow(dead_code)] // Retained RE constant: no live reader today, kept with the table it was decoded into.
pub const MSGBOX_FINISHED_FALSE: u8 = false as u8;
pub const AUTO_ACCEPT_LOG_INTERVAL: usize = 30;
...
pub static MSGBOX_FINISHED_ORIG: AtomicUsize = AtomicUsize::new(HOOK_ORIGINAL_UNSET);
pub use er_telemetry_core::counters::AUTO_ACCEPT_INSTALLED;
pub const AUTO_ACCEPT_NOT_INSTALLED: usize = 0;
pub const AUTO_ACCEPT_INSTALLED_YES: usize = 1;
...
pub use er_telemetry_core::counters::IN_WORLD_REACHED;
pub use er_telemetry_core::counters::LOADGAME_BUILDER_LAST_NATIVE_SLOT;
pub use er_telemetry_core::counters::LOADGAME_BUILDER_SLOT_OVERRIDES;
#[allow(dead_code)] // Retained RE constant: no live reader today, kept with the table it was decoded into.
pub const IN_WORLD_NOT_REACHED: usize = 0;
...
pub use er_telemetry_core::counters::BOOT_VIEW_COMPOSITE_EPOCH;
pub use er_telemetry_core::counters::BOOT_VIEW_COMPOSITE_FIRST_MS;
...
pub use er_telemetry_core::counters::BOOT_VIEW_EPOCH_WORLD_LIVE;
...
pub const BOOT_VIEW_EPOCH_COMPOSITE_CAP_MS: u64 = 20_000;
...
pub const MSGBOX_BUILDER_RVA: u32 = MsgBoxRva::Builder as u32;
pub static MSGBOX_BUILDER_ORIG: AtomicUsize = AtomicUsize::new(HOOK_ORIGINAL_UNSET);
pub static MSGBOX_BUILDER_LOG: AtomicUsize = AtomicUsize::new(MENU_TRACE_UNSEEN_SEQ);
pub const MSGBOX_BUILDER_LOG_MAX: usize = TraceSampleLimit::Value24 as usize;
...
pub const POLICY_TOS_TITLE_CTOR_RVA: u32 = 0x9b5970;
pub const POLICY_TOS_TITLE_CTOR_WRAPPER_RVA: u32 = 0x9b6070;
pub const POLICY_TOS_SELECTOR_WRAPPER_RVA: u32 = 0x9b6140;
pub const POLICY_TOS_SELECTOR_CTOR_RVA: u32 = 0x9b49f0;
#[allow(dead_code)] // Retained RE address: decoded from the game binary, no live caller today.
pub const POLICY_TOS_SELECTOR_VTABLE_RVA: usize = 0x2b27788;
pub const POLICY_TOS_TITLE_VTABLE_RVA: usize = 0x2b28100;
pub const POLICY_TOS_TITLE_TEXT_PATH_RVA: usize = 0x2b27330;
pub static POLICY_TOS_TITLE_CTOR_ORIG: AtomicUsize = AtomicUsize::new(HOOK_ORIGINAL_UNSET);
pub static POLICY_TOS_TITLE_CTOR_WRAPPER_ORIG: AtomicUsize = AtomicUsize::new(HOOK_ORIGINAL_UNSET);
pub static POLICY_TOS_SELECTOR_WRAPPER_ORIG: AtomicUsize = AtomicUsize::new(HOOK_ORIGINAL_UNSET);
pub static POLICY_TOS_SELECTOR_CTOR_ORIG: AtomicUsize = AtomicUsize::new(HOOK_ORIGINAL_UNSET);
pub use er_telemetry_core::counters::POLICY_TOS_TITLE_HOOK_INSTALLED;
pub const POLICY_TOS_TITLE_HOOK_NOT_INSTALLED: usize = 0;
pub const POLICY_TOS_TITLE_HOOK_INSTALLED_YES: usize = 1;
pub static POLICY_TOS_TITLE_TOTAL_BUILDS: AtomicUsize = AtomicUsize::new(MENU_TRACE_UNSEEN_SEQ);
...
pub use er_telemetry_core::counters::POLICY_TOS_TITLE_SUPPRESSED_BUILDS;
...
pub const POLICY_TOS_MODAL_SUPPRESSED_RETURN: usize = 0;
pub static POLICY_TOS_TITLE_LAST_THIS: AtomicUsize =
    AtomicUsize::new(TITLE_OWNER_SCAN_START_ADDRESS);
pub static POLICY_TOS_TITLE_LAST_VTABLE: AtomicUsize =
    AtomicUsize::new(TITLE_OWNER_SCAN_START_ADDRESS);
pub static POLICY_TOS_TITLE_LAST_ARG_RDX: AtomicUsize =
    AtomicUsize::new(TITLE_OWNER_SCAN_START_ADDRESS);
pub static POLICY_TOS_TITLE_LAST_ARG_R8: AtomicUsize =
    AtomicUsize::new(TITLE_OWNER_SCAN_START_ADDRESS);
pub static POLICY_TOS_TITLE_LAST_ARG_R9: AtomicUsize =
    AtomicUsize::new(TITLE_OWNER_SCAN_START_ADDRESS);
pub static POLICY_TOS_TITLE_LAST_STACK_ARG0: AtomicUsize =
    AtomicUsize::new(TITLE_OWNER_SCAN_START_ADDRESS);
pub static POLICY_TOS_TITLE_LAST_BACKING_FLAG_PTR: AtomicUsize =
    AtomicUsize::new(TITLE_OWNER_SCAN_START_ADDRESS);
pub static POLICY_TOS_TITLE_LAST_STORED_BACKING_FLAG_PTR: AtomicUsize =
    AtomicUsize::new(TITLE_OWNER_SCAN_START_ADDRESS);
pub static POLICY_TOS_TITLE_LAST_BACKING_FLAG_VALUE: AtomicUsize =
    AtomicUsize::new(TITLE_OWNER_SCAN_START_ADDRESS);
pub static POLICY_TOS_TITLE_LAST_REQUESTED_FLAG_VALUE: AtomicUsize =
    AtomicUsize::new(TITLE_OWNER_SCAN_START_ADDRESS);
pub static POLICY_TOS_TITLE_LAST_CALLER_RVA: AtomicUsize =
    AtomicUsize::new(TITLE_OWNER_SCAN_START_ADDRESS);
pub static POLICY_TOS_TITLE_WRAPPER_HITS: AtomicUsize = AtomicUsize::new(MENU_TRACE_UNSEEN_SEQ);
pub const POLICY_TOS_TITLE_WRAPPER_THIS_ADJUST: usize = 0x8;
pub static POLICY_TOS_TITLE_WRAPPER_LAST_RECORD: AtomicUsize =
    AtomicUsize::new(TITLE_OWNER_SCAN_START_ADDRESS);
pub static POLICY_TOS_TITLE_WRAPPER_LAST_ORIGINAL_THIS: AtomicUsize =
    AtomicUsize::new(TITLE_OWNER_SCAN_START_ADDRESS);
pub static POLICY_TOS_TITLE_WRAPPER_LAST_ORIGINAL_VTABLE: AtomicUsize =
    AtomicUsize::new(TITLE_OWNER_SCAN_START_ADDRESS);
pub static POLICY_TOS_TITLE_WRAPPER_LAST_RECORD_ID: AtomicUsize =
    AtomicUsize::new(TITLE_OWNER_SCAN_START_ADDRESS);
pub static POLICY_TOS_TITLE_WRAPPER_LAST_STACK_ARG0: AtomicUsize =
    AtomicUsize::new(TITLE_OWNER_SCAN_START_ADDRESS);
pub static POLICY_TOS_TITLE_WRAPPER_LAST_BACKING_FLAG_PTR: AtomicUsize =
    AtomicUsize::new(TITLE_OWNER_SCAN_START_ADDRESS);
pub static POLICY_TOS_TITLE_WRAPPER_LAST_RET: AtomicUsize =
    AtomicUsize::new(TITLE_OWNER_SCAN_START_ADDRESS);
pub static POLICY_TOS_TITLE_WRAPPER_LAST_CALLER_RVA: AtomicUsize =
    AtomicUsize::new(TITLE_OWNER_SCAN_START_ADDRESS);
pub static POLICY_TOS_SELECTOR_WRAPPER_HITS: AtomicUsize = AtomicUsize::new(MENU_TRACE_UNSEEN_SEQ);
pub static POLICY_TOS_SELECTOR_WRAPPER_LAST_RECORD: AtomicUsize =
    AtomicUsize::new(TITLE_OWNER_SCAN_START_ADDRESS);
pub static POLICY_TOS_SELECTOR_WRAPPER_LAST_ORIGINAL_THIS: AtomicUsize =
    AtomicUsize::new(TITLE_OWNER_SCAN_START_ADDRESS);
pub static POLICY_TOS_SELECTOR_WRAPPER_LAST_ORIGINAL_VTABLE: AtomicUsize =
    AtomicUsize::new(TITLE_OWNER_SCAN_START_ADDRESS);
pub static POLICY_TOS_SELECTOR_WRAPPER_LAST_OWNER: AtomicUsize =
    AtomicUsize::new(TITLE_OWNER_SCAN_START_ADDRESS);
pub static POLICY_TOS_SELECTOR_WRAPPER_LAST_REQUESTED_FLAG: AtomicUsize =
    AtomicUsize::new(TITLE_OWNER_SCAN_START_ADDRESS);
pub static POLICY_TOS_SELECTOR_WRAPPER_LAST_SELECTOR_ARG: AtomicUsize =
    AtomicUsize::new(TITLE_OWNER_SCAN_START_ADDRESS);
pub static POLICY_TOS_SELECTOR_WRAPPER_LAST_RET: AtomicUsize =
    AtomicUsize::new(TITLE_OWNER_SCAN_START_ADDRESS);
pub static POLICY_TOS_SELECTOR_WRAPPER_LAST_CALLER_RVA: AtomicUsize =
    AtomicUsize::new(TITLE_OWNER_SCAN_START_ADDRESS);
pub static POLICY_TOS_SELECTOR_CTOR_HITS: AtomicUsize = AtomicUsize::new(MENU_TRACE_UNSEEN_SEQ);
pub static POLICY_TOS_SELECTOR_CTOR_LAST_THIS: AtomicUsize =
    AtomicUsize::new(TITLE_OWNER_SCAN_START_ADDRESS);
pub static POLICY_TOS_SELECTOR_CTOR_LAST_VTABLE: AtomicUsize =
    AtomicUsize::new(TITLE_OWNER_SCAN_START_ADDRESS);
pub static POLICY_TOS_SELECTOR_CTOR_LAST_OWNER: AtomicUsize =
    AtomicUsize::new(TITLE_OWNER_SCAN_START_ADDRESS);
pub static POLICY_TOS_SELECTOR_CTOR_LAST_REQUESTED_FLAG_PTR: AtomicUsize =
    AtomicUsize::new(TITLE_OWNER_SCAN_START_ADDRESS);
pub static POLICY_TOS_SELECTOR_CTOR_LAST_REQUESTED_FLAG_VALUE: AtomicUsize =
    AtomicUsize::new(TITLE_OWNER_SCAN_START_ADDRESS);
pub static POLICY_TOS_SELECTOR_CTOR_LAST_SELECTOR_ARG: AtomicUsize =
    AtomicUsize::new(TITLE_OWNER_SCAN_START_ADDRESS);
pub static POLICY_TOS_SELECTOR_CTOR_LAST_STORED_SELECTOR_ARG: AtomicUsize =
    AtomicUsize::new(TITLE_OWNER_SCAN_START_ADDRESS);
pub static POLICY_TOS_SELECTOR_CTOR_LAST_STORED_REQUESTED_FLAG_PTR: AtomicUsize =
    AtomicUsize::new(TITLE_OWNER_SCAN_START_ADDRESS);
pub static POLICY_TOS_SELECTOR_CTOR_LAST_RET: AtomicUsize =
    AtomicUsize::new(TITLE_OWNER_SCAN_START_ADDRESS);
pub static POLICY_TOS_SELECTOR_CTOR_LAST_CALLER_RVA: AtomicUsize =
    AtomicUsize::new(TITLE_OWNER_SCAN_START_ADDRESS);
...
pub const POLICY_TOS_STATUS_PREDICATE_RVA: u32 = 0x9b72b0;
pub const POLICY_TOS_FLAG_SETTER_RVA: u32 = 0x9b6b30;
pub static POLICY_TOS_STATUS_PREDICATE_ORIG: AtomicUsize = AtomicUsize::new(HOOK_ORIGINAL_UNSET);
pub static POLICY_TOS_FLAG_SETTER_ORIG: AtomicUsize = AtomicUsize::new(HOOK_ORIGINAL_UNSET);
pub static POLICY_TOS_STATUS_HITS: AtomicUsize = AtomicUsize::new(MENU_TRACE_UNSEEN_SEQ);
pub static POLICY_TOS_STATUS_LAST_THIS: AtomicUsize =
    AtomicUsize::new(TITLE_OWNER_SCAN_START_ADDRESS);
pub static POLICY_TOS_STATUS_LAST_OWNER: AtomicUsize =
    AtomicUsize::new(TITLE_OWNER_SCAN_START_ADDRESS);
pub static POLICY_TOS_STATUS_LAST_FLAG_PTR: AtomicUsize =
    AtomicUsize::new(TITLE_OWNER_SCAN_START_ADDRESS);
pub static POLICY_TOS_STATUS_LAST_FLAG_VALUE: AtomicUsize =
    AtomicUsize::new(TITLE_OWNER_SCAN_START_ADDRESS);
pub static POLICY_TOS_STATUS_LAST_RET: AtomicUsize =
    AtomicUsize::new(TITLE_OWNER_SCAN_START_ADDRESS);
pub static POLICY_TOS_STATUS_LAST_CALLER_RVA: AtomicUsize =
    AtomicUsize::new(TITLE_OWNER_SCAN_START_ADDRESS);
pub static POLICY_TOS_FLAG_SETTER_HITS: AtomicUsize = AtomicUsize::new(MENU_TRACE_UNSEEN_SEQ);
pub static POLICY_TOS_FLAG_SETTER_LAST_OWNER: AtomicUsize =
    AtomicUsize::new(TITLE_OWNER_SCAN_START_ADDRESS);
pub static POLICY_TOS_FLAG_SETTER_LAST_VALUE: AtomicUsize =
    AtomicUsize::new(TITLE_OWNER_SCAN_START_ADDRESS);
pub static POLICY_TOS_FLAG_SETTER_LAST_FORCE: AtomicUsize =
    AtomicUsize::new(TITLE_OWNER_SCAN_START_ADDRESS);
pub static POLICY_TOS_FLAG_SETTER_LAST_BEFORE: AtomicUsize =
    AtomicUsize::new(TITLE_OWNER_SCAN_START_ADDRESS);
pub static POLICY_TOS_FLAG_SETTER_LAST_AFTER: AtomicUsize =
    AtomicUsize::new(TITLE_OWNER_SCAN_START_ADDRESS);
pub static POLICY_TOS_FLAG_SETTER_LAST_CALLER_RVA: AtomicUsize =
    AtomicUsize::new(TITLE_OWNER_SCAN_START_ADDRESS);
pub static START_POLICY_TOS_TITLE_HOOK: Once = Once::new();
/// Observe-only user32 window-reconfiguration hooks (bd er-effects-rs-rzow).
pub static START_WINDOW_RECONFIG_OBSERVER: Once = Once::new();
...
pub const SERVER_STATUS_FORMATTER_RVA: u32 = 0x83ac60;
pub const SERVER_STATUS_RECORD_STATE_OFFSET: usize = 0x0;
pub const SERVER_STATUS_RECORD_TEXT_ID_OFFSET: usize = 0x10;
pub const SERVER_STATUS_CHECKING_NETWORK_TEXT_ID: usize = 401_120;
pub const SERVER_STATUS_LOGGING_IN_TEXT_ID: usize = 401_150;
pub const SERVER_STATUS_RETRIEVING_DATA_TEXT_ID: usize = 401_160;
pub const SERVER_STATUS_SAVING_DATA_TEXT_ID: usize = 401_165;
pub static SERVER_STATUS_FORMATTER_ORIG: AtomicUsize = AtomicUsize::new(HOOK_ORIGINAL_UNSET);
pub use er_telemetry_core::counters::SERVER_STATUS_HOOK_INSTALLED;
pub const SERVER_STATUS_HOOK_NOT_INSTALLED: usize = 0;
pub const SERVER_STATUS_HOOK_INSTALLED_YES: usize = 1;
pub static SERVER_STATUS_TOTAL_SEEN: AtomicUsize = AtomicUsize::new(MENU_TRACE_UNSEEN_SEQ);
pub static SERVER_STATUS_LAST_STATE: AtomicUsize = AtomicUsize::new(TITLE_OWNER_SCAN_START_ADDRESS);
pub static SERVER_STATUS_LAST_TEXT_ID: AtomicUsize =
    AtomicUsize::new(TITLE_OWNER_SCAN_START_ADDRESS);
pub static START_SERVER_STATUS_HOOK: Once = Once::new();
#[allow(dead_code)] // Retained RE constant: no live reader today, kept with the table it was decoded into.
pub const AUTO_ACCEPT_VT_LOG_MAX: usize = 24;
...
pub const SCENE_OBJ_PROXY_CTOR_RVA: u32 = 0x74a700;
...
pub use er_telemetry_core::counters::LATCHED_MENU_WINDOW;
/// One-shot install guard for the MenuWindow-latch factory hook (mirrors AUTO_ACCEPT_INSTALLED).
pub use er_telemetry_core::counters::MENU_WINDOW_LATCH_INSTALLED;
/// Trampoline for the SceneObjProxy-ctor latch hook (0 = unset).
pub use er_telemetry_core::counters::SCENE_OBJ_PROXY_CTOR_ORIG;
pub const MENU_WINDOW_LATCH_NOT_INSTALLED: usize = 0;
pub const MENU_WINDOW_LATCH_INSTALLED_YES: usize = 1;
pub static START_MENU_WINDOW_LATCH: Once = Once::new();
...
#[allow(dead_code)] // Retained RE address: decoded from the game binary, no live caller today.
pub const SYSTEM_QUIT_COMPONENT_INDEX_PATCH_RVA: usize = 0x93bb41;
#[allow(dead_code)] // Retained RE constant: no live reader today, kept with the table it was decoded into.
pub const SYSTEM_QUIT_COMPONENT_INDEX_EXPECTED_GAME_END: u8 = 0x0e;
#[allow(dead_code)] // Retained RE constant: no live reader today, kept with the table it was decoded into.
pub const SYSTEM_QUIT_COMPONENT_INDEX_REPLACEMENT_MULTI_SLOT: u8 = 0x02;
#[allow(dead_code)] // Retained RE constant: no live reader today, kept with the table it was decoded into.
pub const SYSTEM_QUIT_COMPONENT_INDEX_PATCH_LEN: usize = 1;
...
#[allow(dead_code)] // Retained RE constant: no live reader today, kept with the table it was decoded into.
pub const SYSTEM_QUIT_LOAD_LINEHELP_ID: u32 = 406000;
/// Live/deobf `GetGR_LineHelp(MenuString*, int)` (dump `0x140760880` -> live `0x140760790`).
#[allow(dead_code)] // Retained RE address: decoded from the game binary, no live caller today.
pub const GET_GR_LINEHELP_ENTRY_RVA: u32 = 0x760790;
...
pub const MSG_REPOSITORY_GET_AND_FORMAT_RVA: u32 = 0x7633d0;
...
pub const MSG_REPOSITORY_FORMAT_RVA: u32 = 0x7638b0;
...
pub const MENU_STRING_FROM_WIDE_RVA: u32 = 0x6758a0;
...
pub const SYSTEM_QUIT_FIRST_ROW_MENU_TEXT_ID: i32 = 110510;
pub const SYSTEM_QUIT_FIRST_ROW_LINEHELP_ID: i32 = 110500;
pub const SYSTEM_QUIT_SECOND_ROW_MENU_TEXT_ID: i32 = 110511;
pub const SYSTEM_QUIT_SECOND_ROW_LINEHELP_ID: i32 = 110501;
pub const SYSTEM_QUIT_SAVE_GAME_DIALOG_ID: i32 = 110000;
...
pub const SYSTEM_QUIT_SAVE_REQUEST_PROFILE_RVA: u32 = 0x67a420;
pub const SYSTEM_QUIT_REQUEST_SAVE_RVA: u32 = 0x67a520;
...
pub const SAVE_REQUEST_RETRACT_B72_RVA: u32 = 0x678740;
pub const SAVE_REQUEST_RETRACT_B73_RVA: u32 = 0x678710;
...
// has already pointed at. Full stage map lives on `er_telemetry_core::counters::SAVE_FLOW_STAGE`.
//
...
pub const SAVE_FLOW_STAGE_IDLE: usize = 0;
...
pub const SAVE_FLOW_STAGE_DEST_BROWSE: usize = 3;
...
pub const SAVE_FLOW_STAGE_OVERWRITE_CONFIRM: usize = 4;
/// WP2: the user declined (or a recipe failure aborted); the close sequence is running and
/// NOTHING will be written.
pub const SAVE_FLOW_STAGE_CLOSING_ABORT: usize = 5;
pub const SAVE_FLOW_STAGE_CLOSING_COMMIT: usize = 6;
pub const SAVE_FLOW_STAGE_FIRE_GATE_WAIT: usize = 7;
pub const SAVE_FLOW_STAGE_COMMIT_WAIT: usize = 8;
...
pub const SAVE_FLOW_FIRE_GATE_TIMEOUT_TICKS: usize = 600;
...
/// native save.
pub const SAVE_BYPASS_WATCHDOG_TICKS: usize = 900;
...
pub const CS_MENU_MAN_SAVE_GATE_SUB_80_OFFSET: usize = 0x80;
pub const CS_MENU_MAN_SAVE_GATE_LATCH_290_OFFSET: usize = 0x290;
pub const CS_MENU_MAN_SAVE_GATE_LATCH_298_OFFSET: usize = 0x298;
pub use er_telemetry_core::counters::SAVE_FLOW_B72_BEFORE_FIRE;
pub use er_telemetry_core::counters::SAVE_FLOW_B73_BEFORE_FIRE;
pub use er_telemetry_core::counters::SAVE_FLOW_BYPASS_ALLOWED_AT_FIRE;
pub use er_telemetry_core::counters::SAVE_FLOW_COMMIT_COMPLETE_COUNT;
pub use er_telemetry_core::counters::SAVE_FLOW_COMMIT_JOB_START_TICK;
pub use er_telemetry_core::counters::SAVE_FLOW_COMMIT_VERIFY_FAIL_COUNT;
pub use er_telemetry_core::counters::SAVE_FLOW_COMMIT_WATCHDOG_COUNT;
pub use er_telemetry_core::counters::SAVE_FLOW_DIALOG;
pub use er_telemetry_core::counters::SAVE_FLOW_DISPATCH_CALLS_AT_FIRE;
pub use er_telemetry_core::counters::SAVE_FLOW_DISPATCH_DECLINES_AT_FIRE;
pub use er_telemetry_core::counters::SAVE_FLOW_ENQUEUE_MISSING_COUNT;
pub use er_telemetry_core::counters::SAVE_FLOW_FLAG_UNREAD;
pub use er_telemetry_core::counters::SAVE_FLOW_REQUEST_RETRACTIONS;
pub use er_telemetry_core::counters::SAVE_FLOW_RETRACT_DECLINED;
pub use er_telemetry_core::counters::SAVE_FLOW_ROW_PRESS_COUNT;
pub use er_telemetry_core::counters::SAVE_FLOW_SAVE_JOB_STARTS_AT_FIRE;
pub use er_telemetry_core::counters::SAVE_FLOW_SERIALIZE_CALLS_AT_FIRE;
pub use er_telemetry_core::counters::SAVE_FLOW_SERIALIZE_FAILURES_AT_FIRE;
pub use er_telemetry_core::counters::SAVE_FLOW_SUBMITS_SWALLOWED_AT_FIRE;
...
pub const SAVE_FLOW_ENQUEUE_GRACE_TICKS: usize = 180;
pub use er_telemetry_core::counters::SAVE_FLOW_GATE_LATCH_BLOCKED_COUNT;
pub use er_telemetry_core::counters::SAVE_FLOW_STAGE;
pub use er_telemetry_core::counters::SAVE_FLOW_STAGE_TICKS;
...
pub use er_telemetry_core::counters::SAVE_FLOW_ABORT_COUNT;
pub use er_telemetry_core::counters::SAVE_FLOW_BOX_BUILD_TIMEOUT_COUNT;
pub use er_telemetry_core::counters::SAVE_FLOW_BOX_DIALOG;
pub use er_telemetry_core::counters::SAVE_FLOW_BOX_EMIT_COUNT;
pub use er_telemetry_core::counters::SAVE_FLOW_BOX_EMIT_DIALOG;
pub use er_telemetry_core::counters::SAVE_FLOW_BOX_EMIT_STATE;
pub use er_telemetry_core::counters::SAVE_FLOW_BOX_EXPECTED;
pub use er_telemetry_core::counters::SAVE_FLOW_BOX_IDENTITY_LOST_COUNT;
pub use er_telemetry_core::counters::SAVE_FLOW_BOX_NO_COUNTS;
pub use er_telemetry_core::counters::SAVE_FLOW_BOX_OPEN_COUNTS;
pub use er_telemetry_core::counters::SAVE_FLOW_BOX_RESULT_BASELINE;
pub use er_telemetry_core::counters::SAVE_FLOW_BOX_UNDECIDABLE_COUNTS;
pub use er_telemetry_core::counters::SAVE_FLOW_BOX_YES_COUNTS;
pub use er_telemetry_core::counters::SAVE_FLOW_RECIPE_UNAVAILABLE;
pub use er_telemetry_core::counters::SAVE_FLOW_SUBMIT_BOX_PENDING;
...
pub const SAVE_FLOW_BOX_BUILD_TIMEOUT_TICKS: usize = 180;
pub use er_telemetry_core::counters::SAVE_FLOW_BOX_HOST_DIALOG;
...
pub use er_telemetry_core::counters::SAVE_DEST_CONFIRM_PENDING;
pub use er_telemetry_core::counters::SAVE_DEST_OVERWRITE_UNCONFIRMABLE_COUNT;
...
pub const SAVE_DEST_PICKER_OPEN_TIMEOUT_TICKS: usize = 180;
...
pub use er_telemetry_core::counters::SAVE_DEST_DISARM_DEFERRED;
pub use er_telemetry_core::counters::SAVE_DEST_DISARM_UNPROVEN;
pub use er_telemetry_core::counters::SAVE_DEST_FOREIGN_OPEN_PASSED;
pub use er_telemetry_core::counters::SAVE_DEST_IDENTITY_UNKNOWN_ABORT;
pub use er_telemetry_core::counters::SAVE_DEST_LIVE_STAT_UNREADABLE;
pub use er_telemetry_core::counters::SAVE_DEST_NO_WRITER_OBSERVER_ABORT;
pub use er_telemetry_core::counters::SAVE_DEST_RESTORE_FAILED;
pub use er_telemetry_core::counters::SAVE_DEST_RESTORE_SUPPRESSED;
pub use er_telemetry_core::counters::SAVE_DEST_SELF_REDIRECT_BLOCKED;
pub use er_telemetry_core::counters::SAVE_FLOW_DEGRADED_COMPLETE_COUNT;
pub use er_telemetry_core::counters::SAVE_FLOW_DEGRADED_FIRE;
pub use er_telemetry_core::counters::SAVE_FLOW_DEGRADED_UNOBSERVED_COUNT;
pub use er_telemetry_core::counters::SAVE_FLOW_SAVE_JOB_COMPLETIONS_AT_FIRE;
...
pub const SAVE_DEST_TEARDOWN_UNPROVEN_EXTRA_TICKS: usize = 3600;
/// `PropertyEditDialog` pointer stored at `action_object + 0x8` -- how every System>Quit row
/// action reaches its owning dialog.
pub const SYSTEM_QUIT_ACTION_OBJECT_DIALOG_08_OFFSET: usize = 0x8;
...
pub const SYSTEM_QUIT_MSGBOX_BUILDER_CTOR_RVA: u32 = 0x7af730;
/// `add_yes(rcx=builder, rdx=&SaveFlowYesButtonDesc) -> builder` (localized Yes label).
pub const SYSTEM_QUIT_MSGBOX_ADD_YES_RVA: u32 = 0x7b1c70;
/// `add_no(rcx=builder) -> builder` (localized No/Cancel label; builds its own descriptor).
pub const SYSTEM_QUIT_MSGBOX_ADD_NO_RVA: u32 = 0x7b1900;
...
pub const MSGBOX_BUILDER_SIZE: usize = 0x1140;
...
pub const MSGBOX_BUILDER_MODE_CONFIRM: i32 = 0x17;
/// Builder trailing byte argument (5th stack arg) every native confirm passes.
pub const MSGBOX_BUILDER_CTOR_TRAILING_ARG: u8 = 0;
/// Buttons added so far (`builder+0x10f0`), incremented by each adder.
pub const MSGBOX_BUILDER_BUTTON_COUNT_OFF: usize = 0x10f0;
/// Default/initial cursor index (`builder+0x28`), written by `default_last`.
pub const MSGBOX_BUILDER_DEFAULT_IDX_OFF: usize = 0x28;
...
pub const SYSTEM_QUIT_DIALOG_MENU_JOB_QUEUE_10_OFFSET: usize = 0x10;
pub const SYSTEM_QUIT_DIALOG_MENU_WINDOW_LIST_50_OFFSET: usize = 0x50;
/// `CS::MenuString` is 0x38 bytes: `MenuHelpLabelComponent` stores its second MenuString at
/// `MENU_HELP_LABEL_HELP_OFFSET`.
pub const MENU_STRING_SIZE: usize = MENU_HELP_LABEL_HELP_OFFSET;
/// One-shot spawn guard for the boot-time er-save-suppress install thread (bootstrap.rs).
pub static START_SAVE_SUPPRESS: Once = Once::new();
...
pub static START_SAVE_FILE_OPS_CORE: Once = Once::new();
...
pub const SYSTEM_QUIT_RETURN_TITLE_ACTION_DO_CALL_RVA: u32 = 0x961640;
...
pub const SYSTEM_QUIT_RETURN_DESKTOP_ACTION_DO_CALL_RVA: u32 = 0x9610d0;
...
pub const PROPERTY_NEW_BUTTON_CONTROLLER_ACTIVATE_RVA: u32 = 0x9749f0;
...
pub const PROPERTY_NEW_BUTTON_CONTROLLER_SHOULD_INVOKE_RVA: u32 = 0x974b00;
/// Non-canonical marker copied into only the cloned quick-load action payload; the invoke hook eats it.
#[allow(dead_code)] // Retained RE constant: no live reader today, kept with the table it was decoded into.
pub const SYSTEM_QUIT_NOOP_ACTION_SENTINEL: usize = 0x4552_5351_4e4f_4f50;
...
pub const PROPERTY_NEW_BUTTON_CONTROLLER_ACTION_OBJECT_OFFSET: usize = 0xa8;
...
pub const MENU_VIEWER_PAD_CONFIRM_PRESSED_RVA: u32 = er_game_base::rva::MENU_VIEWER_PAD_CONFIRM_PRESSED_RVA;
pub const MENU_VIEWER_PAD_MOUSE_CLICKED_RVA: u32 = er_game_base::rva::MENU_VIEWER_PAD_MOUSE_CLICKED_RVA;
...
/// shorter list.
pub const GRID_CONTROL_SET_ITEM_COUNT_RVA: u32 = 0x738dc0;
...
pub static SYSTEM_QUIT_DUPLICATE_ORIG: AtomicUsize = AtomicUsize::new(HOOK_ORIGINAL_UNSET);
pub static SYSTEM_QUIT_NOOP_ACTION_ORIG: AtomicUsize = AtomicUsize::new(HOOK_ORIGINAL_UNSET);
pub static SYSTEM_QUIT_RETURN_DESKTOP_ACTION_ORIG: AtomicUsize =
    AtomicUsize::new(HOOK_ORIGINAL_UNSET);
pub static PROPERTY_NEW_BUTTON_CONTROLLER_ACTIVATE_ORIG: AtomicUsize =
    AtomicUsize::new(HOOK_ORIGINAL_UNSET);
pub static SYSTEM_QUIT_SAVE_GAME_GET_AND_FORMAT_ORIG: AtomicUsize =
    AtomicUsize::new(HOOK_ORIGINAL_UNSET);
pub static SYSTEM_QUIT_SAVE_GAME_RETURN_TITLE_REQUEST_ORIG: AtomicUsize =
    AtomicUsize::new(HOOK_ORIGINAL_UNSET);
pub use er_telemetry_core::counters::PROPERTY_NEW_BUTTON_CONTROLLER_ACTIVATE_INSTALLED;
pub use er_telemetry_core::counters::SYSTEM_QUIT_DUPLICATE_INSTALLED;
pub use er_telemetry_core::counters::SYSTEM_QUIT_NOOP_ACTION_INSTALLED;
pub use er_telemetry_core::counters::SYSTEM_QUIT_RETURN_DESKTOP_ACTION_INSTALLED;
pub use er_telemetry_core::counters::SYSTEM_QUIT_SAVE_GAME_CONFIRM_INSTALLED;
pub use er_telemetry_core::counters::SYSTEM_QUIT_SAVE_GAME_TEXT_INSTALLED;
pub const SYSTEM_QUIT_DUPLICATE_NOT_INSTALLED: usize = 0;
pub const SYSTEM_QUIT_DUPLICATE_INSTALLED_YES: usize = 1;
pub const SYSTEM_QUIT_NOOP_ACTION_NOT_INSTALLED: usize = 0;
pub const SYSTEM_QUIT_NOOP_ACTION_INSTALLED_YES: usize = 1;
pub const SYSTEM_QUIT_RETURN_DESKTOP_ACTION_NOT_INSTALLED: usize = 0;
pub const SYSTEM_QUIT_RETURN_DESKTOP_ACTION_INSTALLED_YES: usize = 1;
pub const PROPERTY_NEW_BUTTON_CONTROLLER_ACTIVATE_NOT_INSTALLED: usize = 0;
pub const PROPERTY_NEW_BUTTON_CONTROLLER_ACTIVATE_INSTALLED_YES: usize = 1;
pub const SYSTEM_QUIT_SAVE_GAME_TEXT_NOT_INSTALLED: usize = 0;
pub const SYSTEM_QUIT_SAVE_GAME_TEXT_INSTALLED_YES: usize = 1;
pub const SYSTEM_QUIT_SAVE_GAME_CONFIRM_NOT_INSTALLED: usize = 0;
pub const SYSTEM_QUIT_SAVE_GAME_CONFIRM_INSTALLED_YES: usize = 1;
pub use er_telemetry_core::counters::SYSTEM_QUIT_DUPLICATE_COUNT;
...
pub use er_telemetry_core::counters::SYSTEM_QUIT_NATIVE_SAVE_GAME_ACTION_LAST_OBJECT;
...
pub static SYSTEM_QUIT_NATIVE_RETURN_DESKTOP_ACTION_LAST_OBJECT: AtomicUsize = AtomicUsize::new(0);
...
pub use er_telemetry_core::counters::SYSTEM_QUIT_LOAD_PROFILE_CONTROLLER_LAST_OBJECT;
/// Recorded cloned action implementation object for the quick-load row; only this action is routed.
pub use er_telemetry_core::counters::SYSTEM_QUIT_NOOP_ACTION_LAST_OBJECT;
pub use er_telemetry_core::counters::SYSTEM_QUIT_NOOP_SELECTION_COUNT;
pub use er_telemetry_core::counters::SYSTEM_QUIT_OPEN_SAVE_DIR_ACTION_COUNT;
...
pub use er_telemetry_core::counters::SYSTEM_QUIT_OPEN_SAVE_DIR_ACTION_LAST_OBJECT;
/// Recorded `PropertyNewButtonController` for the save-folder row. This is the authoritative click
/// dispatch identity when the GFx/native bridge bypasses the action-object thunk.
pub use er_telemetry_core::counters::SYSTEM_QUIT_OPEN_SAVE_DIR_CONTROLLER_LAST_OBJECT;
pub use er_telemetry_core::counters::SYSTEM_QUIT_OPEN_SAVE_DIR_FAILURE_COUNT;
pub use er_telemetry_core::counters::SYSTEM_QUIT_OPEN_SAVE_DIR_SUCCESS_COUNT;
pub use er_telemetry_core::counters::SYSTEM_QUIT_SAVE_GAME_ACTION_COUNT;
pub use er_telemetry_core::counters::SYSTEM_QUIT_SAVE_GAME_CLOSE_COUNT;
pub use er_telemetry_core::counters::SYSTEM_QUIT_SAVE_GAME_CONFIRM_COUNT;
pub use er_telemetry_core::counters::SYSTEM_QUIT_SAVE_GAME_DEFER_TOP_FRAMES;
pub use er_telemetry_core::counters::SYSTEM_QUIT_SAVE_GAME_DEFER_TOP_WINDOW;
pub use er_telemetry_core::counters::SYSTEM_QUIT_SAVE_GAME_TEXT_SUBSTITUTION_COUNT;
...
pub use er_telemetry_core::counters::{
    SYSTEM_QUIT_LOAD_BUILD_URL_ACCEPTED_COUNT, SYSTEM_QUIT_LOAD_BUILD_URL_ACTION_COUNT,
    SYSTEM_QUIT_LOAD_BUILD_URL_ACTION_LAST_OBJECT, SYSTEM_QUIT_LOAD_BUILD_URL_CANCELLED_COUNT,
...
pub use er_telemetry_core::counters::SYSTEM_QUIT_PROFILE_LOAD_JOB_SLOT;
pub use er_telemetry_core::counters::SYSTEM_QUIT_ROW_INDEX_GENERATE_BUILD_LINK_PLUS1;
pub use er_telemetry_core::counters::SYSTEM_QUIT_ROW_INDEX_LOAD_BUILD_URL_PLUS1;
pub use er_telemetry_core::counters::SYSTEM_QUIT_ROW_INDEX_LOAD_PROFILE_PLUS1;
pub use er_telemetry_core::counters::SYSTEM_QUIT_ROW_INDEX_LOAD_SAVE_PROFILES_PLUS1;
pub use er_telemetry_core::counters::SYSTEM_QUIT_ROW_INDEX_RETURN_DESKTOP_PLUS1;
pub use er_telemetry_core::counters::SYSTEM_QUIT_ROW_INDEX_SAVE_GAME_PLUS1;
pub use er_telemetry_core::counters::SYSTEM_QUIT_ROW_TABLE_DIALOG;
...
pub use er_telemetry_core::counters::SYSTEM_QUIT_SAVE_GAME_ARMED_DIALOG;
pub use er_telemetry_core::counters::{
    SYSTEM_QUIT_ACTION_ALIAS_FALSE_QUIT_CLAIMS, SYSTEM_QUIT_GRID_COLS, SYSTEM_QUIT_GRID_ITEM_COUNT,
    SYSTEM_QUIT_GRID_NAVIGABLE_CELLS, SYSTEM_QUIT_GRID_ROWS, SYSTEM_QUIT_QUIT_AUTHORIZED_COUNT,
    ...
    SYSTEM_QUIT_ROW_RESOLVED_BY_CURSOR_ROW_COUNT,
};
/// Live/deobf native `05_010_ProfileSelect` wrapper (`FUN_14081f7e0` dump -> live `0x14081f6f0`).
pub const PROFILE_SELECT_WRAPPER_RVA: u32 = 0x81f6f0;
...
#[allow(dead_code)] // Retained RE address: decoded from the game binary, no live caller today.
pub const MENU_JOB_CHAIN_MENU_JOBS_RVA: u32 = 0x7a7bb0;
...
#[allow(dead_code)] // Retained RE address: decoded from the game binary, no live caller today.
pub const SYSTEM_QUIT_PROFILE_LOAD_JOB_BUILDER_RVA: u32 = 0x826510;
/// Live/deobf native Quit Game return-title chain builder (`FUN_14079d7f0` dump -> live `0x14079d700`).
pub const SYSTEM_QUIT_RETURN_TITLE_CHAIN_BUILDER_RVA: u32 = 0x79d700;
...
pub const MENU_WINDOW_LIST_PUSH_RVA: u32 = 0x733ef0;
...
pub const MENU_WINDOW_ROOT_PROXY_CTOR_RVA: u32 = 0x747980;
...
pub const SCALEFORM_HANDLER_CTOR_RVA: usize = 0x11a8870;
pub const SCALEFORM_HANDLER_DTOR_RVA: usize = 0x11a8900;
pub static SCALEFORM_HANDLER_CTOR_ORIG: AtomicUsize = AtomicUsize::new(HOOK_ORIGINAL_UNSET);
pub static SCALEFORM_HANDLER_DTOR_ORIG: AtomicUsize = AtomicUsize::new(HOOK_ORIGINAL_UNSET);
pub use er_telemetry_core::counters::SCALEFORM_HANDLER_TRACE_INSTALLED;
...
pub static SCALEFORM_HANDLER_LIVE: std::sync::Mutex<Vec<usize>> = std::sync::Mutex::new(Vec::new());
pub const SCALEFORM_HANDLER_LIVE_CAP: usize = 8192;
...
pub use er_telemetry_core::counters::SCALEFORM_HANDLER_CTORS;
pub use er_telemetry_core::counters::SCALEFORM_HANDLER_DOUBLE_FREES;
pub use er_telemetry_core::counters::SCALEFORM_HANDLER_DTORS;
pub use er_telemetry_core::counters::SCALEFORM_HANDLER_LAST_DOUBLE_FREE_OBJ;
...
pub const MENU_WINDOW_JOB_DTOR_RVA: usize = 0x7ac720;
...
pub const MENU_WINDOW_JOB_FINALIZE_RVA: usize = 0x7ada40;
// THE MSB-PARSE / STEP_LoadListWait / DLC-VIRTUAL-ROOT TRACE ADDRESSES ARE NOT IN THIS TABLE.
// They moved out on 2026-08-25 with the traces that owned them, into
// `crates/er-diag-harness/src/rva.rs`: `MSB_FILECAP_PARSE_CALLBACK_RVA` (0x21bbf0),
// `STEP_LOADLIST_WAIT_RVA` (0xaf1800), `DLC_ROOTS_BLANK_RVA` (0xe06490) and `DLC_ROOTS_JOB_RVA`
// (0x836f30), plus the `MOVEMAPLISTSTEP_*` gate operands and the verbose-call budgets. This table
// carried them only because it was lifted out of the root crate while those three traces still
// compiled into the product DLL -- they had no reader here other than the traces, and one game
// address gets exactly one literal declaration (`scripts/check-rva-alias-drift.py`).
//
// `DLC_ROOTS_REFILL_RVA`, `CSDLC_SINGLETON_RVA` and `DLC_ROOT_ALIAS_NAME` below did NOT move: the
// DLC-root self-heal in `dlc_roots_self_heal.rs` is product code and names all three.
...
pub const DLC_ROOTS_REFILL_RVA: usize = er_game_base::rva::DLC_ROOTS_REFILL_RVA;
/// `GLOBAL_CSDlc` -- the `CSDlcImp` singleton. Grounded from `FUN_1408371e0`'s own load:
/// `mov 0x354f9ed(%rip),%rcx  # 0x143d86bd8`.
pub const CSDLC_SINGLETON_RVA: usize = er_game_base::rva::CSDLC_SINGLETON_RVA;
/// The DLIO alias every failing `m28` read resolves through.
pub const DLC_ROOT_ALIAS_NAME: &str = "mapstudio_dlc2";

pub const MENU_WINDOW_JOB_OWNING_WINDOW_OFFSET: usize = 0x130;
...
pub const MENU_WINDOW_MENU_ID_OFFSET: usize = 0x180;
pub const MENU_WINDOW_MENU_ID_UNMAPPED_SENTINEL: u16 = 0xffff;
/// `vfptr[3]` slot (the finalize's `call *0x18(vtable)`): the window's get-input-descriptor method.
pub const MENU_WINDOW_INPUT_DESC_VTABLE_SLOT: usize = 0x18;
...
pub const MENU_WINDOW_EVENT_INDEX_SANE_MAX: i32 = 0x1000;
/// Scratch out-buffer size for the reproduced `vfptr[3]` call (descriptors are small; oversized).
pub const MENU_WINDOW_INPUT_DESC_SCRATCH_LEN: usize = 0x200;
...
pub const GAME_MODULE_VTABLE_SPAN: usize = 0x0800_0000;
...
pub const MENU_WINDOW_JOB_PUSH_TARGET_50_OFFSET: usize = 0x50;
...
pub const MENU_WINDOW_LIST_REMOVE_RVA: usize = 0x733d70;
...
pub const MENU_WINDOW_LIST_COUNT_48_OFFSET: usize = 0x48;
pub const MENU_WINDOW_LIST_SANE_MAX_COUNT: i32 = 64;
pub static MENU_WINDOW_JOB_DTOR_ORIG: AtomicUsize = AtomicUsize::new(HOOK_ORIGINAL_UNSET);
pub use er_telemetry_core::counters::MENU_WINDOW_JOB_DTOR_DOOMED_GUARDS;
pub use er_telemetry_core::counters::MENU_WINDOW_JOB_DTOR_LAST_GUARDED_INDEX;
pub use er_telemetry_core::counters::MENU_WINDOW_JOB_DTOR_LAST_GUARDED_WINDOW;
pub use er_telemetry_core::counters::MENU_WINDOW_JOB_DTOR_LIST_REMOVALS;
pub use er_telemetry_core::counters::MENU_WINDOW_JOB_DTOR_PRESERVED_STALE_DETACHES;
pub use er_telemetry_core::counters::MENU_WINDOW_JOB_DTOR_TRACE_INSTALLED;
// THE MSB-PARSE / LOADLIST-WAIT / DLC-ROOT TRACE COUNTERS ARE DELIBERATELY ABSENT FROM THIS TABLE.
// They left `er_telemetry_core::counters` on 2026-08-25 together with the traces that owned them:
// `crates/er-diag-harness/` holds them as PRIVATE statics beside `msb_parse_trace.rs`,
// `loadlist_wait_trace.rs` and `dlc_roots_trace.rs`. This table only ever listed them because it
// was lifted out of the root crate while those three traces still compiled into the product DLL --
// nothing in this crate read one, and re-exporting them here would make a product crate name a
// diagnostics crate's state and quietly undo that extraction.
//
// `DLC_ROOTS_REFILL_ORIG` is the single exception, and it stayed in `er-telemetry-core` for a
// product reason: `dlc_roots_self_heal.rs` reads it to prefer a live trampoline over the raw
// `game_rva` fallback. It is now always 0 in a product-only profile (the detour that filled it
// lives in the other image), which is the intended reading -- the fallback resolves the
// un-detoured native, and under product + harness it enters the harness detour, which forwards.
pub use er_telemetry_core::counters::DLC_ROOTS_REFILL_ORIG;
pub use er_telemetry_core::counters::{
...
pub const MASQUERADE_PRESERVED_JOB_SLOTS: usize = 4;
pub static MASQUERADE_PRESERVED_JOBS: [AtomicUsize; MASQUERADE_PRESERVED_JOB_SLOTS] = [
    AtomicUsize::new(0),
    AtomicUsize::new(0),
    AtomicUsize::new(0),
    AtomicUsize::new(0),
...
pub const MENU_OFFSCR_REND_PARAM_LOOKUP_RVA: usize = 0xd3ed90;
/// Declared once in `er-game-base::rva`; the seamless-bugfixes guard tests the same slot.
pub const SOLO_PARAM_REPOSITORY_PTR_RVA: usize =
    er_game_base::rva::SOLO_PARAM_REPOSITORY_GLOBAL_RVA;
pub const GET_PARAM_RESCAP_RVA: usize = 0xd4cc50;
pub const MENU_OFFSCR_REND_PARAM_TYPE: u32 = 0x4e;
pub static MENU_OFFSCR_REND_PARAM_LOOKUP_ORIG: AtomicUsize = AtomicUsize::new(HOOK_ORIGINAL_UNSET);
pub use er_telemetry_core::counters::MENU_OFFSCR_REND_PARAM_LOOKUP_INSTALLED;
pub use er_telemetry_core::counters::QUIT_TO_DESKTOP_CLEAN_KILLS;
...
pub const CSSCALEFORMVALUE_DISPLAY_TYPE_VALUE: i32 = 10;
...
pub const OPTIONSETTING_DISPLAY_INFO_BYTES: usize = 0xE0;
pub const OPTIONSETTING_DISPLAY_INFO_VISIBLE_OFFSET: usize = 0xd6;
...
pub use er_telemetry_core::counters::OPTIONSETTING_ACTIVELY_SHOWN;
...
pub use er_telemetry_core::counters::OPTIONSETTING_CURRENT_DIALOG;
pub use er_telemetry_core::counters::OPTIONSETTING_CURRENT_PANE_DATATYPE;
...
pub use er_telemetry_core::counters::OPTIONSETTING_CURRENT_PANE_EVER_VISIBLE;
pub use er_telemetry_core::counters::OPTIONSETTING_CURRENT_PANE_VISIBLE;
...
pub use er_telemetry_core::counters::OPTIONSETTING_CURRENT_TAB;
pub use er_telemetry_core::counters::OPTIONSETTING_LAST_FLAG;
/// Count of samples where the blank-pane signature fired (`WindowList` resolved but NOT visible).
pub use er_telemetry_core::counters::OPTIONSETTING_PANE_BLANK_DETECTED_COUNT;
/// Last sample: whether the composite sub-dialog job slot was bound (0/1).
pub use er_telemetry_core::counters::OPTIONSETTING_PANE_COMPOSITE_BOUND;
/// Count of vcalls skipped fail-closed because objectInterface/vtable/getfn were not game-image-live.
pub use er_telemetry_core::counters::OPTIONSETTING_PANE_GUARD_SKIPS;
/// Last sample: the `WindowList` child's raw dataType (for gate diagnosis).
pub use er_telemetry_core::counters::OPTIONSETTING_PANE_LAST_DATATYPE;
/// Last sample: bitmask (bit N = pane N of `OPTIONSETTING_PANE_NAMES`) of panes that resolved.
pub use er_telemetry_core::counters::OPTIONSETTING_PANE_LAST_RESOLVED_MASK;
/// Last sample: bitmask of panes whose DisplayInfo.Visible was set.
pub use er_telemetry_core::counters::OPTIONSETTING_PANE_LAST_VISIBLE_MASK;
/// Last sample: whether the `WindowList` container resolved (0/1).
pub use er_telemetry_core::counters::OPTIONSETTING_PANE_LAST_WINDOWLIST_RESOLVED;
/// Last sample: whether the `WindowList` container's DisplayInfo.Visible was set (0/1).
pub use er_telemetry_core::counters::OPTIONSETTING_PANE_LAST_WINDOWLIST_VISIBLE;
/// Total pane-visibility samples taken (one per OptionSetting `MenuWindowJob::Run` with a live owner).
pub use er_telemetry_core::counters::OPTIONSETTING_PANE_SAMPLE_COUNT;
/// Run-stopping oracle: healthy pane was seen, THEN the actively-shown current pane went hidden.
pub use er_telemetry_core::counters::OPTIONSETTING_REAL_BLANK_DETECTED_COUNT;
...
pub use er_telemetry_core::counters::OPTIONSETTING_CURRENT_TAB_AT_BLANK;
pub static SYSTEM_QUIT_OPTIONSETTING_DIRECT_VISIBLE_REAPPLY_COUNT: AtomicUsize =
    AtomicUsize::new(0);
pub static SYSTEM_QUIT_OPTIONSETTING_DIRECT_VISIBLE_LAST_TAB: AtomicUsize =
    AtomicUsize::new(usize::MAX);
pub static SYSTEM_QUIT_OPTIONSETTING_DIRECT_VISIBLE_LAST_OLD_CURRENT: AtomicUsize =
    AtomicUsize::new(TITLE_OWNER_SCAN_START_ADDRESS);
pub static SYSTEM_QUIT_OPTIONSETTING_DIRECT_VISIBLE_LAST_SELECTED: AtomicUsize =
    AtomicUsize::new(TITLE_OWNER_SCAN_START_ADDRESS);
pub use er_telemetry_core::counters::SYSTEM_QUIT_OPTIONSETTING_DIRECT_REFRESH_COUNT;
pub static SYSTEM_QUIT_OPTIONSETTING_DIRECT_REFRESH_LAST_SELECTED: AtomicUsize =
    AtomicUsize::new(TITLE_OWNER_SCAN_START_ADDRESS);
pub use er_telemetry_core::counters::OPTIONSETTING_ACTIVE_ROW_ACTION_HASH;
pub use er_telemetry_core::counters::OPTIONSETTING_ACTIVE_ROW_CLONED_MASK;
pub use er_telemetry_core::counters::OPTIONSETTING_ACTIVE_ROW_COUNT;
pub use er_telemetry_core::counters::OPTIONSETTING_ACTIVE_ROW_DIALOG;
pub use er_telemetry_core::counters::OPTIONSETTING_ACTIVE_ROW_LABEL_HASH;
pub use er_telemetry_core::counters::OPTIONSETTING_ACTIVE_ROW_NATIVE_SAVE_MASK;
pub use er_telemetry_core::counters::OPTIONSETTING_ACTIVE_ROW_QUIT_LABEL_MASK;
...
/// feature is injected.
pub use er_telemetry_core::counters::OPTIONSETTING_ACTIVE_ROW_SAMPLE_COUNT;
pub use er_telemetry_core::counters::OPTIONSETTING_ACTIVE_ROW_TAB;
pub use er_telemetry_core::counters::OPTIONSETTING_GAME_OPTIONS_CLONED_ROW_HITS;
pub use er_telemetry_core::counters::OPTIONSETTING_GAME_OPTIONS_QUIT_LABEL_HITS;
...
pub use er_telemetry_core::counters::OPTIONSETTING_PANE_FIX_APPLIED;
/// window -> SettingTabControl (+0x1870), -> tab view (+0x10), -> selected index (view+0xd4).
pub const OPTIONSETTING_TAB_CONTROL_OFFSET: usize = 0x1870;
pub const OPTIONSETTING_TAB_VIEW_OFFSET: usize = 0x10;
pub const OPTIONSETTING_TAB_VIEW_SELECTED_INDEX_OFFSET: usize = 0xd4;
/// Composite current-dialog embedded pane proxy offset (`dialog+0x1200`; FUN_14093b850 SetVisibles it).
pub const OPTIONSETTING_DIALOG_PANE_PROXY_OFFSET: usize = 0x1200;
...
pub const GX_RESERVE_CMD_QUEUE_SLOT_RVA: usize = 0x1aeae60;
/// Queue-struct field offsets (from the reserve_command_queue_slot decompile).
pub const GX_CMD_QUEUE_COUNT_OFFSET: usize = 0x30;
pub const GX_CMD_QUEUE_CAP_OFFSET: usize = 0x34;
pub static GX_RESERVE_CMD_QUEUE_SLOT_ORIG: AtomicUsize = AtomicUsize::new(HOOK_ORIGINAL_UNSET);
pub use er_telemetry_core::counters::GX_CMD_QUEUE_CAP_SEEN;
...
pub use er_telemetry_core::counters::GX_CMD_QUEUE_MAX_FILL;
pub use er_telemetry_core::counters::GX_CMD_QUEUE_SUBMITS;
pub use er_telemetry_core::counters::GX_CMD_QUEUE_SWITCH_MAX_FILL;
pub use er_telemetry_core::counters::GX_RESERVE_CMD_QUEUE_SLOT_INSTALLED;
...
pub const GX_CMD_QUEUE_HIST_SLOTS: usize = 32;
...
pub static GX_CMD_QUEUE_HIST_COUNTS: [AtomicUsize; GX_CMD_QUEUE_HIST_SLOTS] =
    [const { AtomicUsize::new(0) }; GX_CMD_QUEUE_HIST_SLOTS];
pub use er_telemetry_core::counters::GX_CMD_QUEUE_HIST_DROPPED;
...
pub const GX_CMD_QUEUE_NEARFULL_MARGIN: usize = 24;
pub const GX_CMD_QUEUE_NEARFULL_LOG_EVERY: usize = 64;
pub use er_telemetry_core::counters::GX_CMD_QUEUE_NEARFULL_HITS;
...
pub const GX_CMD_PUMP_RVA: usize = 0x1b3bda0;
pub static GX_CMD_PUMP_ORIG: AtomicUsize = AtomicUsize::new(HOOK_ORIGINAL_UNSET);
pub use er_telemetry_core::counters::GX_CMD_PUMP_CTX;
pub use er_telemetry_core::counters::GX_CMD_PUMP_INSTALLED;
pub const GX_CMD_QUEUE_BUCKET_COUNT: usize = 0x6d;
pub const GX_CMD_QUEUE_BUCKET_BEGIN_OFFSET: usize = 0x30;
pub const GX_CMD_QUEUE_BUCKET_END_OFFSET: usize = 0x34;
pub const GX_CMD_QUEUE_BUCKET_STRIDE: usize = 0x18;
...
pub const GX_CMD_QUEUE_BUCKET_WIDTH_SANE_MAX: i32 = 192;
...
pub const GX_CMD_QUEUE_PEAK_LOG_MIN: usize = 80;
pub const GX_CMD_QUEUE_PEAK_LOG_STEP: usize = 8;
pub use er_telemetry_core::counters::GX_CMD_QUEUE_PEAK_LAST_LOGGED;
...
pub const GX_CMD_QUEUE_ARENA_OFFSET: usize = 0x40;
#[allow(dead_code)] // Retained RE offset: decoded struct layout, no live reader today.
pub const GX_CMD_ARENA_ALLOC_COUNT_OFFSET: usize = 0x14;
pub const GX_CMD_ARENA_LIMIT_OFFSET: usize = 0x20;
pub const GX_CMD_ARENA_CURSOR_OFFSET: usize = 0x28;
/// Low-water sentinel: usize::MAX until the first sample lands.
pub use er_telemetry_core::counters::GX_CMD_ARENA_MIN_REMAINING;
pub use er_telemetry_core::counters::GX_CMD_ARENA_SWITCH_MIN_REMAINING;
...
pub const DELAY_DELETE_MAN_SINGLETON_PTR_RVA: usize = crate::CS_DELAY_DELETE_MAN_GLOBAL_RVA;
pub const DELAY_DELETE_MAN_PENDING_COUNT_OFFSET: usize = 0x40;
pub const DELAY_DELETE_MAN_PENDING_HIGHWATER_OFFSET: usize = 0x44;
/// Sane upper bound for the pending count; a larger read means the singleton RVA/layout is wrong.
pub const DELAY_DELETE_MAN_PENDING_SANE_MAX: usize = 100_000;
...
pub const DELAY_DELETE_ENQUEUE_RVA: usize = 0xe77490;

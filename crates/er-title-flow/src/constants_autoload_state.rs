...
pub const MSB_FILECAP_PARSE_CALLBACK_RVA: usize = 0x21bbf0;
/// How many SUCCESSFUL parses to log before rate-limiting. Null-result parses are always logged.
pub const MSB_PARSE_TRACE_VERBOSE_CALLS: usize = 24;
...
pub const MOVEMAPLISTSTEP_LOADLIST_2C0_OFFSET: usize = 0x2c0;
/// Gate B operand: must be 0 for the step to proceed (`cmp qword [rcx+0xb8],0; jnz bail`).
pub const MOVEMAPLISTSTEP_GATE_B8_OFFSET: usize = 0xb8;
...
pub const LOADLIST_WAIT_TRACE_VERBOSE_CALLS: usize = 6;
...
pub const MSB_PARSE_TRACE_ROOTS_ON_NULL_RESULTS: usize = 4;
...
pub use er_telemetry_core::counters::{DLC_ROOTS_JOB_CALLS, DLC_ROOTS_JOB_ORIG};
pub use er_telemetry_core::counters::{

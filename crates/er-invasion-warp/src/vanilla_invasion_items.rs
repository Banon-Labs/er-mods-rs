...
//!
//! Clearing the bit removes the test. Forcing the online flag instead lies about its input, gets
//! written back by Seamless within a frame or two, and moves all ~22 of that flag's consumers at
//! once where this moves three rows.

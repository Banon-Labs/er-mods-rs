...
pub use er_telemetry_core::counters::PROFILE_DET_RESOLVE_DIAG;
...
pub use er_telemetry_core::counters::PROFILE_LIVE_RT_RES;
pub use er_telemetry_core::counters::RB_FAST_ALLOC;
pub use er_telemetry_core::counters::RB_FAST_BUFFER;
pub use er_telemetry_core::counters::RB_FAST_BUFSIZE;
...
pub use er_telemetry_core::counters::DEPTH_KEY_DIAG_LOGGED;
...
pub use er_telemetry_core::counters::DEPTH_KEY_FRESH;
/// One-shot latch for the interior-histogram ground-truth dump when even the valley pass fails.
pub use er_telemetry_core::counters::DEPTH_KEY_HIST_DUMPED;
...
pub use er_telemetry_core::counters::RB_DEPTH_BUFFER;
pub use er_telemetry_core::counters::RB_DEPTH_BUFSIZE;
...
pub use er_telemetry_core::counters::PROFILE_MASK_HEAD_MISMATCH_STREAK;
pub use er_telemetry_core::counters::PROFILE_MASK_HEAD_MISMATCH_TOTAL;

pub use er_telemetry_core::counters::RB_COH_ALLOC;

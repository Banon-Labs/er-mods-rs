use super::*;
// The Scaleform proxy primitives these surfaces share moved to `er-quit-menu-core` with the
// System>Quit link field, which needs them with no product DLL behind it. One declaration, three
// readers: the loading-screen stats text, this editor runtime, and that field.
